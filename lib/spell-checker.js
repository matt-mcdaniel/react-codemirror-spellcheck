        ...
        var overlay = {
            token: function token(stream) {
                ...
                if (word) {
                    ...
                    if (!word.match(rx_ignore) && CodeMirrorSpellChecker.typo && !CodeMirrorSpellChecker.typo.check(word) && ! ~customWords.indexOf(word)) return 'spell-error'; // CSS class: cm-spell-error
                } else {
